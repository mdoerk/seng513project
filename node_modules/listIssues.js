 ...
 */
var getNumPageTotal = exports.getNumPageTotal = function(numPage, sortBy, response, user, sqlQuery) {
	...
	if (sqlQuery == undefined) {
	        sqlQuery = 'SELECT * FROM issues' + sortQuery(sortBy) + ' limit ' + numIssuePage + ' offset ' + (numPage - 1) * numIssuePage;
	}
...
function sortQuery(sortby) {
	if(sortby) {
	  if (direction == " ASC")
		...
		return " ORDER BY 'lastModified'" + direction;
	}
}
