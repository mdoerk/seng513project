 ...
 *
 *	 	Example: find('table_name', { properties:['column_1','column_2'], conditions:['condition_1="value1"', 'condition_2="value2" OR condition_3="value2"'], limit:number, orderby:'column_3 desc/asc' }, callback);
 */
 ...
 *		usage:
 *			runQuery("select .. ... .... ", call_back);     where call_back(results) stores the results
 */
