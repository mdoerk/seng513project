	...
	return function(error, users)
	{
      ...
      response.write('<form id="search-form" action="searchIssue">');
			...
			else
			{
                ...
                if (g_UserVote == -1)
                {
                    response.write('<p><table style="width: 100%"><tr> <td style="width: 31px"><a href="/voteIssues?issueid=' + issue['id'] +	'&vote=1&userID='+g_UserId+'"><img src="images/thumb_up.png"></a></td>');
                    response.write('<td style="width: 49px">Like</td><td style="width: 31px"><a href="/voteIssues?issueid=' + issue['id'] +	 '&vote=0&userID='+g_UserId+'"><img src="images/thumb_down.png"></a></td>');
                    response.write('<td>Unlike</td></tr></table></p>'); 
                }
                else if (g_UserVote == 1)
                {
