...
function printPage(response) 
{
	...
	{	
        ...
        response.write('<title>CivicConnect - List of Issues </title>');
		...
		response.write('<tr>');
		response.write('<td class="text-center-style" style="width: 69px"><h3>Status</h3></td>');
		response.write('<td class="text-center-style" style="width: 201px"><h3>Title</h3></td>');
		response.write('<td class="text-center-style" style="width: 550px"><h3>Description</h3></td>');
		...
		for (i=0; i<rows.length; i++)
		{
			...
			response.write('<a href="' + rows[i]['link'] + '">');
			response.write(rows[i]['title']);
			response.write('</a>');
			response.write('</td>');
			
			//Column 3
			response.write('<td style="width: 550px" class="text-center-style">');
			response.write(rows[i]['description']);
			response.write('</td>');
		...
		response.write('</div> <div id="footer"><p>&copy; 2011 University of Calgary. All rights reserved.</p></div></body> </html>');
