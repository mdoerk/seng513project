	...
	{	
		...
		{	
			var sqlInsertUserVote = "INSERT INTO 'votes' ('user_id', 'issue_id', 'vote') "
				+ "VALUES ('" + g_userId + "', '" + g_IssueId + "', '" + g_userVote + "');";	//Note: if you copy code, please at least rename the variables to something meaningful...
...
*/
VoteIssues.updateIssueVotes = function(issueId, call_back)
{
