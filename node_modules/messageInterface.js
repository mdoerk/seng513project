 ...
 *
 */
function displayNewMessagePage(response, currentUser, sendToUserName, subject) {
	var variables = {
...
NewMessage.display = function(request, response) {
	...
	request.getUser(function(error, currentUser){
		...
		if (currentUser) {
			// Display msgs
			displayNewMessagePage(response, currentUser, qs.tousername, qs.subject);
		}
		else
