...
var rankThresholdBeginner = 50;
var rankThresholdIntermediate = 100;
var rankThresholdAdvanced = 500;
var rankThresholdPro = 1000;

/* getRank
 * Takes in the reputation score of a user and outputs a rank title
 *@param userScore The reputation score of the user
 */
exports.getRank = function(userScore) {
	var rankName;	
	if(userScore >= minScore && userScore < rankThresholdBeginner)
		rankName = "Level 1";
	else if(userScore >= rankThresholdBeginner && userScore < (rankThresholdIntermediate))
		rankName = "Level 2";
	else if(userScore >= rankThresholdIntermediate && userScore < (2*rankThresholdIntermediate))
		rankName = "Level 3";
	else if(userScore >= 2*(rankThresholdIntermediate) && userScore < (3*rankThresholdIntermediate))
		rankName = "Level 4";
	else if(userScore >= 3*(rankThresholdIntermediate) && userScore < (4*rankThresholdIntermediate))	
		rankName = "Level 5";
	else if(userScore >= 4*(rankThresholdIntermediate) && userScore < rankThresholdAdvanced)
		rankName = "Level 6";
	else if(userScore >= rankThresholdAdvanced && userScore < (2*rankThresholdAdvanced))
		rankName = "Level 7";
	else if(userScore >= (2*rankThresholdAdvanced) && userScore < (3*rankThresholdAdvanced))
		rankName = "Level 8";
	else if(userScore >= (3*rankThresholdAdvanced) && userScore < (4*rankThresholdAdvanced))
		rankName = "Level 9";
	else if(userScore >= 1000 && userScore <= maxScore)
		rankName = "Level 10";
