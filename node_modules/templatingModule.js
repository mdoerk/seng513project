...
exports.render = function(template, view, partials, send_fun){
	...
	fs.readFile(template, function(error, contentData){
		...
		//		or better yet, consider keeping the layout file in memory.
		fs.readFile(defaultLayoutPath, function(error, layoutData){
			...
			quickTaskButtons = view.quickTaskButtons_partial || 'views/layouts/defaultQuickTaskButtons_partial.html';
			fs.readFile(quickTaskButtons, function(error, partialData){
