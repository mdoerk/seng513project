					...
					getStats(thisIssueId, function(issueStats) {
						getFollow(g_UserId, thisIssueId, function(follows) {
							...
							tags.getTagsList(issue.id, function(tagList) {
								...
								console.log(thisIssueUserId);
								console.log(g_UserId);
								if ((thisIssueUserId == g_UserId) ){
								    allowEdit = true;			
								...
								//response.render('views/layouts/partials/defaultQuickTaskButtons_partial.html', variables);
