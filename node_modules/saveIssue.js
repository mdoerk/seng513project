...
function updateDB(POST,response){
	...
	var sqlQuery = 'UPDATE issues SET title="' + POST.title +
					'",description="' + POST.description +
					'",location="' + POST.location +
					'",link="' + POST.link +
					'", status="' + POST.status +
					'", fileLocation="' + POST.fileLocation +
					'" WHERE id=' + POST.id;
...
function getPost(request,response){
	...
	form.parse(req, function(err, fields, files){
		...
		if(files.file){
			...
			fields.fileLocation = files.file.path;
		}
		
		fields.fileLocation = fields.deleteFile ? '' : fields.fileLocation;
