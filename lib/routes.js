...
var ListMessages = require('messageInterface').ListMessages;
...
r.add('/messages', ListMessages.display);
//r.add('/sendmessage', MessageCenter.sendMessage);
r.add('/voteComments', VoteComments.display);
r.add('/viewMessage', viewMessage.display);
r.add('/newMessage', NewMessage.display);
